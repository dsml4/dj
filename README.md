...
1. In Dagster(**D**) as an op of the pipeline
2. In Jupyter (**J**) as a notebook
...
In the Dagster context, notebooks' code is locked; only the pipeline configurations can be changed.
